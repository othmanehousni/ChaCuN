...
class MyBoardTest4 {
    ...
    @Test
    void withoutOccupantWorksForPawn() {
        Tile tile = new Tile(12, Tile.Kind.NORMAL, dummyForestSide(12, 0), dummyMeadowSide(12, 1), dummyRiverSide(12, 1, 2, 3), dummyMeadowSide(12, 3));
        Pos pos = new Pos(1, 2);
        PlacedTile placedTile = new PlacedTile(tile, PlayerColor.BLUE, Rotation.NONE, pos);

        Occupant occupant = new Occupant(Occupant.Kind.PAWN, 121);

        Board board = Board.EMPTY.withNewTile(placedTile).withOccupant(occupant).withoutOccupant(occupant);

        assertEquals(placedTile, board.tileAt(pos));
        assertEquals(0, board.occupantCount(PlayerColor.BLUE, Occupant.Kind.PAWN));
    ...
    void withoutGatherersOrFishersInWorks() {
        ...
        // occupants
        Occupant pawn120 = new Occupant(Occupant.Kind.PAWN, 120); // in meadow
        Occupant pawn140 = new Occupant(Occupant.Kind.PAWN, 140); // in first forest
        Occupant pawn161 = new Occupant(Occupant.Kind.PAWN, 161); // in river
        Occupant pawn183 = new Occupant(Occupant.Kind.PAWN, 183); // in river
        Occupant pawn190 = new Occupant(Occupant.Kind.PAWN, 190); // in second forest

        // creation of the board
        Board board = Board.EMPTY
                .withNewTile(placedTile19)
                .withOccupant(pawn190)
                .withNewTile(placedTile18)
                .withOccupant(pawn183)
                .withNewTile(placedTile14)
                .withOccupant(pawn140)
                .withNewTile(placedTile13)
                .withNewTile(placedTile12)
                .withOccupant(pawn120)
                .withNewTile(placedTile16)
                .withOccupant(pawn161)
                .withNewTile(placedTile17)
                .withNewTile(placedTile15);

        // forest and river areas to remove the pawns from
        Area<Zone.Forest> secondForestArea = board.forestArea(forest151);
        Area<Zone.River> riverArea = board.riverArea(river161);

        board = board.withoutGatherersOrFishersIn(Set.of(secondForestArea), Set.of(riverArea));

        // check the areas
        assertTrue(board.forestArea(forest151).occupants().isEmpty());
        assertTrue(board.riverArea(river161).occupants().isEmpty());
        assertEquals(List.of(PlayerColor.PURPLE), board.forestArea(forest140).occupants());
        assertEquals(List.of(PlayerColor.RED), board.meadowArea(meadow120).occupants());
        assertEquals(Set.of(pawn120, pawn140), board.occupants());

        // check the tiles
        assertEquals(placedTile12.withOccupant(pawn120), board.tileWithId(12));
        assertEquals(placedTile13, board.tileWithId(13));
        assertEquals(placedTile14.withOccupant(pawn140), board.tileWithId(14));
        assertEquals(placedTile15, board.tileWithId(15));
        assertEquals(placedTile16, board.tileWithId(16));
        assertEquals(placedTile17, board.tileWithId(17));
        assertEquals(placedTile18, board.tileWithId(18));
        assertEquals(placedTile19, board.tileWithId(19));
    }
    ...
    void withMoreCancelledAnimalsWorks() {
        Animal deer1 = new Animal(1, Animal.Kind.DEER);
        Animal deer2 = new Animal(2, Animal.Kind.DEER);
        Animal deer3 = new Animal(3, Animal.Kind.DEER);
        Animal deer4 = new Animal(4, Animal.Kind.DEER);
        Animal aurochs1 = new Animal(5, Animal.Kind.AUROCHS);
        Animal aurochs2 = new Animal(6, Animal.Kind.AUROCHS);
        Animal aurochs3 = new Animal(7, Animal.Kind.AUROCHS);
        Animal aurochs4 = new Animal(8, Animal.Kind.AUROCHS);
        Animal mammoth1 = new Animal(9, Animal.Kind.MAMMOTH);
        Animal mammoth2 = new Animal(10, Animal.Kind.MAMMOTH);
        Animal mammoth3 = new Animal(11, Animal.Kind.MAMMOTH);
        Animal mammoth4 = new Animal(12, Animal.Kind.MAMMOTH);
        Animal tiger1 = new Animal(13, Animal.Kind.TIGER);
        Animal tiger2 = new Animal(14, Animal.Kind.TIGER);
        Animal tiger3 = new Animal(15, Animal.Kind.TIGER);
        Animal tiger4 = new Animal(16, Animal.Kind.TIGER);

        Set<Animal> animalsPartOne = Set.of(deer1, deer2, aurochs1, aurochs2, mammoth1, mammoth2, tiger1, tiger2);
        Set<Animal> animalsPartTwo = Set.of(deer3, deer4, aurochs3, aurochs4, mammoth3, mammoth4, tiger3, tiger4);
        Set<Animal> allAnimals = new HashSet<>();
        allAnimals.addAll(animalsPartOne);
        allAnimals.addAll(animalsPartTwo);

        Board board = Board.EMPTY.withMoreCancelledAnimals(animalsPartOne);
        assertEquals(animalsPartOne, board.cancelledAnimals());

        board = board.withMoreCancelledAnimals(animalsPartTwo);
        assertEquals(allAnimals, board.cancelledAnimals());
    }

    @Test
    void equalsWorksForSameBoards() {
        Tile tile = new Tile(12, Tile.Kind.NORMAL, dummyForestSide(12, 0), dummyMeadowSide(12, 1), dummyRiverSide(12, 1, 2, 3), dummyMeadowSide(12, 3));
        PlacedTile placedTile = new PlacedTile(tile, PlayerColor.BLUE, Rotation.NONE, new Pos(1, 2));
    ...
    @Test
    void equalsWorksForDifferentBoards() {
        Tile tile = new Tile(12, Tile.Kind.NORMAL, dummyForestSide(12, 0), dummyMeadowSide(12, 1), dummyRiverSide(12, 1, 2, 3), dummyMeadowSide(12, 3));
        PlacedTile placedTile = new PlacedTile(tile, PlayerColor.BLUE, Rotation.NONE, new Pos(1, 2));
        ...
        Board board2 = Board.EMPTY.withNewTile(placedTile).withMoreCancelledAnimals(Set.of(deer)).withOccupant(occupant);
