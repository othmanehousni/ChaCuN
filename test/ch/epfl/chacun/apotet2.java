...
public class apotet2 {
    ...
    void couldPlaceTileWorks() {
        ...
        //False si board empty
        assertFalse(Board.EMPTY.couldPlaceTile(startTile));

        //True si on ajoute tuile 15 a 56
        // Tile 15
        var a0_0_15 = new Animal(15_0_0, Animal.Kind.DEER);
        var z0_15 = new Zone.Meadow(15_0, List.of(a0_0_15), null);
        var z1_15 = new Zone.River(15_1, 0, null);
        ...
        var sW_15 = new TileSide.Meadow(z0_15);
        Tile tile15 = new Tile(15, Tile.Kind.NORMAL, sN_15, sE_15, sS_15, sW_15);
        assertTrue(boardWithStartTile().couldPlaceTile(tile15));

        //False si on ajoute une tuile implacable (plaeau avec uniquement tile 61 à laquelle on ajoute tile 23)
        // Tile 23
        var a0_0_23 = new Animal(23_0_0, Animal.Kind.AUROCHS);
        var z0_23 = new Zone.Meadow(23_0, List.of(a0_0_23), null);
        var z1_23 = new Zone.River(23_1, 0, null);
        var z2_23 = new Zone.Meadow(23_2, List.of(), null);
        var z3_23 = new Zone.Forest(23_3, Zone.Forest.Kind.WITH_MENHIR);
        var sN_23 = new TileSide.River(z0_23, z1_23, z2_23);
        var sE_23 = new TileSide.River(z2_23, z1_23, z0_23);
        var sS_23 = new TileSide.Forest(z3_23);
        var sW_23 = new TileSide.Forest(z3_23);
        Tile tile23 = new Tile(23, Tile.Kind.NORMAL, sN_23, sE_23, sS_23, sW_23);

        // Tile 61
        var a0_0_61  = new Animal(61_0_0, Animal.Kind.MAMMOTH);
        var z0_61  = new Zone.Meadow(61_0, List.of(a0_0_61 ), null);
        var sN_61  = new TileSide.Meadow(z0_61 );
        var sE_61  = new TileSide.Meadow(z0_61 );
        var sS_61  = new TileSide.Meadow(z0_61 );
        var sW_61 = new TileSide.Meadow(z0_61 );
        Tile tile61 = new Tile(61, Tile.Kind.NORMAL, sN_61 , sE_61 , sS_61 , sW_61 );
        PlacedTile placedTile61 = new PlacedTile(tile61,
                null,
                Rotation.NONE,
                new Pos(0, 0),
                null);
        Board boardWith61 = Board.EMPTY.withNewTile(placedTile61);

        assertFalse(boardWith61.couldPlaceTile(tile23));

        //CouldPlaceTile when board with multiple tiles
        Board board = boardWithTilesAround56Occupants();
        assertTrue(board.couldPlaceTile(tile61));
        assertTrue(board.couldPlaceTile(tile23));
