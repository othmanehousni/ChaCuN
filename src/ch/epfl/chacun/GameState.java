...
public record GameState(List<PlayerColor> players, TileDecks tileDecks, Tile tileToPlace, Board board,
     ...
     *                     <p>
     *                     <p>
     *                     !! All private methods in this class were put next to the function where they're called, in order to
     *                     facilitate the understanding of the code and its reading !!
     */
    ...
    public Set<Occupant> lastTilePotentialOccupants() {
        Preconditions.checkArgument(board != Board.EMPTY && board.lastPlacedTile() != null);
    ...
    public GameState withPlacedTile(PlacedTile tile) {
        ...
        switch (tile.specialPowerZone()) {
            ...
            case Zone.Meadow meadow when meadow.specialPower() == HUNTING_TRAP -> {
                ...
                Set<Animal> cancelledDeer = eachTigerEatsOneDeer(adjacentMeadow, newBoard.cancelledAnimals());

                newBoard = newBoard.withMoreCancelledAnimals(animals);

                newMessageBoard = newMessageBoard.withScoredHuntingTrap(currentPlayer(), adjacentMeadow, cancelledDeer);
